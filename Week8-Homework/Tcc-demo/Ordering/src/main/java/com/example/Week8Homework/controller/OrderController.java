...
import com.example.Week8Homework.service.OrderService;
...
public class OrderController {
    ...
    @PostMapping(value = "/orderUpdateShip/{id}")
    public void addOrderAndUpdateShip(@PathVariable("id") Long id){
        orderService.addOrderAndUpdateShip(id);
